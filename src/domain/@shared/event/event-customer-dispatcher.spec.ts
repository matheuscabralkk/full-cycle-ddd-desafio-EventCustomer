...
import LogWhenCustomerCreated1 from '../../customer/event/handler/log-when-customer-created-1';
import LogWhenCustomerCreated2 from '../../customer/event/handler/log-when-customer-created-2';
import LogWhenCustomerAddressChanged from '../../customer/event/handler/log-when-customer-address-changed';
